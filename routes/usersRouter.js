...
router.get('/loginStatus', urlEncodeParser,
    (req, res, next) => {
...
router.post('/login', urlEncodeParser,
    async (req, res, next) => {
...
router.get('/forgetpassword', urlEncodeParser,
    async (req, res, next) => {
        var renderOption = {title: "forget password"};
        res.render('forgetPassword', renderOption);
    });

router.post('/forgetpassword', urlEncodeParser,
    async (req, res, next) => {
        var username = req.body.username;
        var password = req.body.password;
        var inviteCode = req.body.inviteCode;
